...
class Test_EditPassword(unittest.TestCase):
    ...
    # this function change the password correctly so do not run it because the password change correctly
    # please do not run it as password too huge and it is hard to change it
    # def test_Change_Password_Scenario_13(self):
    #     # send old password correct and new password and repeat password is too long
    #     # it will accept it so please do not run it
    #     self.CP.change_password(self.Password, "mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmzzzzzzzzzzzzzzzzzzz"
